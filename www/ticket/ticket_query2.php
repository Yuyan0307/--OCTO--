...
if((!empty($_SESSION['check_word'])) && (!empty($_POST['checkword']))){  //判斷此兩個變數是否為空
     ...
     if($_SESSION['check_word'] == $_POST['checkword']){
		  ...
		  if($rs2>=1){ //比對帳密正確
			...
			//echo '<p> </p><p> </p><a href="../ticket/ticket.php">OK輸入正確，將於一秒後跳轉(按此也可返回)</a>';
			//echo '<meta http-equiv="refresh" content="1; url=../ticket//ticket.php">';
         ...
         echo '<p> </p><p> </p><a href="ticket_query.php">Error驗證碼輸入錯誤，按此返回</a>';
     }
